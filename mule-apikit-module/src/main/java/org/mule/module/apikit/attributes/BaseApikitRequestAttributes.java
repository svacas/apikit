 ...
 * @since 1.0
 */
public class BaseApikitRequestAttributes extends ApikitAttributes {
    ...
    public BaseApikitRequestAttributes(ParameterMap headers, ParameterMap queryParams, ParameterMap uriParams, String requestPath) {
        super(headers);
